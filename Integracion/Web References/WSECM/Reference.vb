...
Namespace WSECM
    ...
    Partial Public Class service
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.Integracion.My.MySettings.Default.Integracion_WSECM_service
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Execute", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function Execute(ByVal xmlCommand As String) As String
            Dim results() As Object = Me.Invoke("Execute", New Object() {xmlCommand})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub ExecuteAsync(ByVal xmlCommand As String)
            Me.ExecuteAsync(xmlCommand, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub ExecuteAsync(ByVal xmlCommand As String, ByVal userState As Object)
            If (Me.ExecuteOperationCompleted Is Nothing) Then
                Me.ExecuteOperationCompleted = AddressOf Me.OnExecuteOperationCompleted
            End If
            Me.InvokeAsync("Execute", New Object() {xmlCommand}, Me.ExecuteOperationCompleted, userState)
        End Sub
